...
class CourseDetailPage extends StatelessWidget {
  final CourseCollection course;
  final IsarService service;

  static void navigate(context, CourseCollection course, IsarService service) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            FutureBuilder<TeacherCollection?>(
            ...
            const Text("Students:"),
            Expanded(
              child: FutureBuilder<List<StudentCollections>>(
