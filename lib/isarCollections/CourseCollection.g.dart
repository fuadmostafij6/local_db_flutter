...
const CourseCollectionSchema = CollectionSchema(
  ...
  links: {
    r'teacher': LinkSchema(
      id: -8173802615078055557,
      name: r'teacher',
      target: r'TeacherCollection',
      single: true,
      linkName: r'courses',
    ),
    r'students': LinkSchema(
      id: 8539987867912579758,
      name: r'students',
      target: r'StudentCollections',
      single: true,
      linkName: r'courses',
    )
  },
...
void _courseCollectionAttach(
  ...
  object.id = id;
  object.teacher
      .attach(col, col.isar.collection<TeacherCollection>(), r'teacher', id);
  object.students
      .attach(col, col.isar.collection<StudentCollections>(), r'students', id);
}
...
extension CourseCollectionQueryLinks
    on QueryBuilder<CourseCollection, CourseCollection, QFilterCondition> {
  QueryBuilder<CourseCollection, CourseCollection, QAfterFilterCondition>
      teacher(FilterQuery<TeacherCollection> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CourseCollection, CourseCollection, QAfterFilterCondition>
      students(FilterQuery<StudentCollections> q) {
    return QueryBuilder.apply(this, (query) {
...
extension CourseCollectionQuerySortBy
  ...
  QueryBuilder<CourseCollection, CourseCollection, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension CourseCollectionQuerySortThenBy
  ...
  QueryBuilder<CourseCollection, CourseCollection, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }
...
extension CourseCollectionQueryWhereDistinct
  ...
  QueryBuilder<CourseCollection, CourseCollection, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CourseCollectionQueryProperty
  ...
  QueryBuilder<CourseCollection, String?, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
